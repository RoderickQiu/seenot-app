...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
adb_target logcat -v time | grep -E 'SeeNot|SeeNotLogger|SeenotSync|sync|SessionManager|IntentParser|ScreenAnalyzer|FloatingIndicator|AndroidRuntime|pauseSession|resumeSession|SeenotAccessibility'
