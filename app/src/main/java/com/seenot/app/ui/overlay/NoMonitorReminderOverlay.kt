...
class NoMonitorReminderOverlay(
    private val context: Context,
    private val appName: String,
    private val onAcknowledge: () -> Unit
) {
    companion object {
        private const val TAG = "NoMonitorReminder"

        @Volatile
        private var currentDialog: NoMonitorReminderOverlay? = null
        ...
        fun show(
            ...
            val dialog = NoMonitorReminderOverlay(
    ...
    fun show() {
        ...
        val title = TextView(context).apply {
            text = context.getString(R.string.no_monitor_reminder_title)
            textSize = 22f
        ...
        val subtitle = TextView(context).apply {
            text = context.getString(R.string.no_monitor_reminder_subtitle)
            textSize = 15f
            setTextColor(primaryTextColor)
            gravity = Gravity.CENTER
            layoutParams = LinearLayout.LayoutParams(
        ...
        val acknowledgeButton = buildButton(
            text = context.getString(R.string.no_monitor_reminder_acknowledge),
        ...
        card.addView(acknowledgeButton)
        ...
        try {
            ...
            Logger.e(TAG, "Failed to show no-monitor reminder overlay", e)
            dismissInternal()
        }
    }
