...
# Gson creates these DTOs reflectively in release builds. Keep their
# constructors, fields, annotations, and names stable enough for Gson.
...
-keepclassmembers class com.seenot.app.** {
